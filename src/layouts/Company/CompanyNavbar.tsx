...
const defaultItems: Item[] = [
  { key: "company-detail", label: "Company Detail", to: "/company/:companyId", icon: "settings", perm: "COMPANY_DETAIL_VIEW" },
  { key: "access-role", label: "Access Role", to: "/companies/:companyId/access-role", icon: "grid", perm: ["ROLE_LIST_VIEW", "MEMBER_LIST_VIEW"] },
  { key: "projects", label: "Projects", to: "/companies/:companyId/project", icon: "layers", perm: "PROJECT_LIST_VIEW", children: [{ name: "All project", to: "/companies/:companyId/project" }] },
