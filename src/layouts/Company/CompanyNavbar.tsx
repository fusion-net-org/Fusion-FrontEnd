...
const Preset: Record<PresetIcon, JSX.Element> = {
  ...
  users: (<svg viewBox="0 0 24 24" className="cmp-nav__svg" fill="none">
  ...
  shield:(<svg viewBox="0 0 24 24" className="cmp-nav__svg" fill="none">
            <path d="M12 3l7 3v6c0 4.5-3 7.5-7 9-4-1.5-7-4.5-7-9V6l7-3z" stroke="currentColor" strokeWidth="1.6"/>
          </svg>),
  settings:(<svg viewBox="0 0 24 24" className="cmp-nav__svg" fill="none">
...
const defaultItems: Item[] = [
  ...
  { key: "detail1",     label: "Detail",      to: "/company/detail-1",     icon: "doc" },
  ...
  return (
    <aside className="cmp-nav">
      <nav className="cmp-nav__menu">
        ...
        {/* container riêng cho items để căn indicator chính xác */}
